 ...
 *
 * Because `clearAll` and `reverseBlocks` are stable `useCallback` references,
 * and GridDataContext's memoized value only changes when grid/orderConfig/pattern
 * change, this component is shielded from hover and drag state changes entirely.
 *
 ...
 */
const UtilityButtons: React.FC = memo(function UtilityButtons() {
